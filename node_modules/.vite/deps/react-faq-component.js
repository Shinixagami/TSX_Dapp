...
function d(t2, e2) {
  return !e2 || typeof e2 != "object" && typeof e2 != "function" ? w(t2) : e2;
}
function f(t2) {
  var e2 = function() {
...
!function(t2, e2) {
  ...
  if (t2 && typeof document != "undefined") {
    ...
    n2.type = "text/css", o2 === "top" && r2.firstChild ? r2.insertBefore(n2, r2.firstChild) : r2.appendChild(n2), n2.styleSheet ? n2.styleSheet.cssText = t2 : n2.appendChild(document.createTextNode(t2));
  }
...
var v = function(o2) {
  ...
  return s(_2, [{ key: "getSnapshotBeforeUpdate", value: function(t2, e2) {
    var o3 = e2.isExpanded, r2 = this.state.isExpanded, n3 = this.props.config, s2 = (n3 = n3 === void 0 ? {} : n3).animate, a2 = s2 === void 0 || s2;
    return r2 !== o3 ? { rowClassName: r2 ? a2 ? "expanding" : "expanded" : a2 ? "closing" : "closed" } : null;
  } }, { key: "componentDidUpdate", value: function(t2, e2, o3) {
    var r2 = this.props.config, n3 = (r2 = r2 === void 0 ? {} : r2).animate, s2 = n3 === void 0 || n3;
    o3 !== null && this.setState(function(t3) {
      for (var e3 = 1; e3 < arguments.length; e3++) {
        var o4 = arguments[e3] != null ? arguments[e3] : {};
    ...
    var e2 = this.props, o3 = e2.data, r2 = o3.title, n3 = o3.content, s2 = e2.config, a2 = (s2 = s2 === void 0 ? {} : s2).animate, l2 = a2 === void 0 || a2, c2 = s2.arrowIcon, _3 = s2.expandIcon, p2 = s2.collapseIcon, w2 = s2.tabFocus, d2 = w2 !== void 0 && w2, f2 = this.state, y2 = f2.isExpanded, v2 = f2.ref, h2 = f2.height, g = f2.rowClassName, b = f2.rowRef, m = { onClick: this.expand, role: "button", "aria-expanded": y2, "aria-controls": "react-faq-rowcontent-".concat(this.props.rowid), onKeyPress: this.keyPress, onKeyDown: this.keyPress };
    d2 && (m.tabIndex = 0);
    ...
    var Y = [u["row-content"], "row-content", l2 ? u.animate : u.static].join(" "), D = [u["row-content-text"], "row-content-text"].join(" "), N = n3 && typeof n3 == "string" ? import_react.default.createElement("div", { className: D, dangerouslySetInnerHTML: { __html: n3 } }) : import_react.default.createElement("div", { className: D }, n3);
...
// dep:react-faq-component
var react_faq_component_default = index_es_default;
export {
  react_faq_component_default as default
};
