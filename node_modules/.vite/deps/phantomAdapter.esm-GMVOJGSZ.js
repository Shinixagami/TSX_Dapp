...
var import_loglevel, detectProvider, PhantomAdapter;
var init_phantomAdapter_esm = __esm({
  "node_modules/@web3auth/phantom-adapter/dist/phantomAdapter.esm.js"() {
    ...
    PhantomAdapter = class extends BaseAdapter {
      constructor() {
        let options = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
        super();
      ...
      async init(options) {
        ...
        try {
          ...
          import_loglevel.default.error("Failed to connect with cached phantom provider", error);
...
//# sourceMappingURL=phantomAdapter.esm-GMVOJGSZ.js.map
